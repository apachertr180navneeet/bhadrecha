...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-3">
        <div>
            <h5 class="fw-bold mb-1">Edit Company Loan</h5>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.loan.company-loan.update', $companyLoan->id) }}">
                @csrf @method('PUT')
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="company_id" class="form-select @error('company_id') is-invalid @enderror" required>
                            ...
                            <option value="{{ $company->id }}" {{ old('company_id', $companyLoan->company_id) == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="bank_id" id="bank_id" class="form-select @error('bank_id') is-invalid @enderror" required>
                            ...
                            @foreach($banks as $bank)
                                <option value="{{ $bank->id }}" {{ old('bank_id', $companyLoan->bank_id) == $bank->id ? 'selected' : '' }}>{{ $bank->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="loan_id" class="form-control @error('loan_id') is-invalid @enderror" value="{{ old('loan_id', $companyLoan->loan_id) }}" placeholder="Enter loan ID" required>
                        @error('loan_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Loan Amount <span class="text-danger">*</span></label>
                        <input type="number" step="0.01" name="loan_amount" class="form-control @error('loan_amount') is-invalid @enderror" value="{{ old('loan_amount', $companyLoan->loan_amount) }}" placeholder="Enter loan amount" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="given_amount" class="form-control @error('given_amount') is-invalid @enderror" value="{{ old('given_amount', $companyLoan->given_amount) }}" placeholder="Enter given amount" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="interest_rate" class="form-control @error('interest_rate') is-invalid @enderror" value="{{ old('interest_rate', $companyLoan->interest_rate) }}" placeholder="Enter interest rate" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="tenure_months" class="form-control @error('tenure_months') is-invalid @enderror" value="{{ old('tenure_months', $companyLoan->tenure_months) }}" placeholder="Enter tenure in months" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="emi_amount" id="emi_amount" class="form-control @error('emi_amount') is-invalid @enderror" value="{{ old('emi_amount', $companyLoan->emi_amount) }}" placeholder="Auto-calculated" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="hidden" name="total_interest" id="total_interest" value="{{ old('total_interest', $companyLoan->total_interest) }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Remaining Amount</label>
                        <input type="text" id="remaining_amount_display" class="form-control" placeholder="Auto-calculated" readonly>
                        <input type="hidden" name="remaining_amount" id="remaining_amount" value="{{ old('remaining_amount', $companyLoan->remaining_amount) }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Given EMI Count <span class="text-danger">*</span></label>
                        <input type="number" name="given_emi_count" class="form-control @error('given_emi_count') is-invalid @enderror" value="{{ old('given_emi_count', $companyLoan->given_emi_count) }}" placeholder="Enter EMIs given" required>
                        @error('given_emi_count')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Pending EMI Date</label>
                        <input type="date" max="9999-12-31" name="pending_emi_date" class="form-control @error('pending_emi_date') is-invalid @enderror" value="{{ old('pending_emi_date', $companyLoan->pending_emi_date?->format('Y-m-d')) }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="tenure_calculation" class="form-control @error('tenure_calculation') is-invalid @enderror" rows="3" placeholder="Enter tenure calculation details or notes">{{ old('tenure_calculation', $companyLoan->tenure_calculation) }}</textarea>
        ...
        if (bankId) {
            fetch('{{ url("admin/loan/company-loan/get-branches") }}/' + bankId)
                ...
                .then(data => {
                    ...
                    data.forEach(branch => {
                        const selected = '{{ old("branch_id", $companyLoan->branch_id) }}' == branch.id ? 'selected' : '';
