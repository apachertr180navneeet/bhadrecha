...
<div class="container-fluid flex-grow-1 container-p-y" style="overflow-x:hidden;">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-3">
        <div>
            <h5 class="fw-bold mb-1">Edit Trip</h5>
    ...
    <form method="POST" action="{{ route('admin.transport.trips.update', $trip->id) }}">
        @csrf @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <p class="fw-semibold">{{ $trip->builty->lr_no }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">Date</label>
                        <p class="fw-semibold">{{ $trip->builty->lr_date ? date('d M Y', strtotime($trip->builty->lr_date)) : '-' }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">Consignor</label>
                        <p class="fw-semibold">{{ $trip->builty->consignor->name ?? '-' }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">Consignee</label>
                        <p class="fw-semibold">{{ $trip->builty->consignee->name ?? '-' }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">From</label>
                        <p class="fw-semibold">{{ $trip->builty->originCity->name ?? '-' }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">To</label>
                        <p class="fw-semibold">{{ $trip->builty->destinationCity->name ?? '-' }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">Total Amount</label>
                        <p class="fw-semibold">₹{{ number_format($trip->builty->total_amount, 2) }}</p>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">Advance Amount</label>
                        <p class="fw-semibold">₹{{ number_format($trip->builty->advance_amount, 2) }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="fasttag_total_amount" id="fasttag_total_amount" class="form-control" value="{{ old('fasttag_total_amount', $trip->fasttag_total_amount) }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Fuel Amount</label>
                        <input type="number" step="0.01" name="fuel_amount" id="fuel_amount" class="form-control" value="{{ old('fuel_amount', $trip->fuel_amount) }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Other Amount</label>
                        <input type="number" step="0.01" name="other_amount" id="other_amount" class="form-control" value="{{ old('other_amount', $trip->other_amount) }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">AdBlue Amount</label>
                        <input type="number" step="0.01" name="adblue_total_amount" id="adblue_total_amount" class="form-control" value="{{ old('adblue_total_amount', $trip->adblue_total_amount) }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Advance Amount</label>
                        <input type="number" step="0.01" name="advance_total_amount" id="advance_total_amount" class="form-control" value="{{ old('advance_total_amount', $trip->advance_total_amount) }}" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div id="fastTagContainer">
                    @forelse($trip->fastTagDetails as $i => $ft)
                    <div class="detail-entry border rounded p-3 mb-3">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label small">Transaction Time</label>
                                <input type="text" name="fast_tag_details[{{ $i }}][transaction_time]" class="form-control form-control-sm datetime-picker" placeholder="DD-Mon-YY hh:mm AM/PM" value="{{ $ft->transaction_time ? $ft->transaction_time->format('Y-m-d H:i') : '' }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Amount (₹)</label>
                                <input type="number" step="0.01" name="fast_tag_details[{{ $i }}][amount]" class="form-control form-control-sm fast-tag-amount" value="{{ $ft->amount }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Location</label>
                                <input type="text" name="fast_tag_details[{{ $i }}][location]" class="form-control form-control-sm" placeholder="Location" value="{{ $ft->location }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">One Way (₹)</label>
                                <input type="number" step="0.01" name="fast_tag_details[{{ $i }}][one_way]" class="form-control form-control-sm fast-tag-oneway" value="{{ $ft->one_way }}">
                            </div>
                        </div>
                        <div class="row g-3 mt-1">
                            <div class="col-md-3">
                                <label class="form-label small">Description</label>
                                <input type="text" name="fast_tag_details[{{ $i }}][description]" class="form-control form-control-sm" placeholder="Description" value="{{ $ft->description }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Transaction ID</label>
                                <input type="text" name="fast_tag_details[{{ $i }}][transaction_id]" class="form-control form-control-sm" placeholder="Txn ID" value="{{ $ft->transaction_id }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Return (₹)</label>
                                <input type="number" step="0.01" name="fast_tag_details[{{ $i }}][return]" class="form-control form-control-sm fast-tag-return" value="{{ $ft->return }}">
                            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div id="fuelContainer">
                    @forelse($trip->fuelDetails as $i => $fd)
                    <div class="fuel-entry border rounded p-3 mb-3">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label small">Date</label>
                                <input type="date" max="9999-12-31" name="fuel_details[{{ $i }}][date]" class="form-control form-control-sm" value="{{ $fd->date ? $fd->date->format('Y-m-d') : '' }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Fuel Company</label>
                                <select name="fuel_details[{{ $i }}][fuel_company_id]" class="form-select form-select-sm fuel-company-select">
                                    <option value="">Select Company</option>
                                    @foreach($fuelCompanies as $company)
                                    <option value="{{ $company->id }}" {{ $fd->fuel_company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Fuel Pump</label>
                                <select name="fuel_details[{{ $i }}][fuel_pump_id]" class="form-select form-select-sm fuel-pump-select">
                                    <option value="">Select Pump</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Qty (L)</label>
                                <input type="number" step="0.01" name="fuel_details[{{ $i }}][quantity]" class="form-control form-control-sm fuel-quantity" value="{{ $fd->quantity }}">
                            </div>
                        </div>
                        <div class="row g-3 mt-1">
                            <div class="col-md-3">
                                <label class="form-label small">Rate (₹)</label>
                                <input type="number" step="0.01" name="fuel_details[{{ $i }}][rate]" class="form-control form-control-sm fuel-rate" value="{{ $fd->rate }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Amount (₹)</label>
                                <input type="number" step="0.01" name="fuel_details[{{ $i }}][amount]" class="form-control form-control-sm fuel-amount" value="{{ $fd->amount }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Odometer (KM)</label>
                                <input type="number" step="0.01" name="fuel_details[{{ $i }}][km]" class="form-control form-control-sm fuel-km" value="{{ $fd->km }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Payment Type</label>
                                <select name="fuel_details[{{ $i }}][payment_type]" class="form-select form-select-sm">
                                    <option value="">Select</option>
                                    <option value="credit" {{ $fd->payment_type == 'credit' ? 'selected' : '' }}>Credit</option>
                                    <option value="debit" {{ $fd->payment_type == 'debit' ? 'selected' : '' }}>Debit</option>
                                    <option value="cash" {{ $fd->payment_type == 'cash' ? 'selected' : '' }}>Cash</option>
                                </select>
                            </div>
                        </div>
                        <div class="row g-3 mt-1">
                            <div class="col-md-9">
                                ...
                                <input type="text" name="fuel_details[{{ $i }}][remark]" class="form-control form-control-sm" placeholder="Remark" maxlength="500" value="{{ $fd->remark }}">
                            </div>
                            <div class="col-md-3 d-flex align-items-end justify-content-end">
                                <button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="bx bx-trash me-1"></i> Remove</button>
                            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm table-sm-compact" id="adblueTable">
                        ...
                        <tbody id="adblueContainer">
                            @forelse($trip->adblueDetails as $i => $ad)
                            <tr class="adblue-row">
                                <td><input type="date" max="9999-12-31" name="adblue_details[{{ $i }}][date]" class="form-control form-control-sm" value="{{ $ad->date ? $ad->date->format('Y-m-d') : '' }}"></td>
                                <td>
                                    <select name="adblue_details[{{ $i }}][adblue_company_id]" class="form-select form-select-sm adblue-company-select">
                                        <option value="">Select Company</option>
                                        @foreach($adblueCompanies as $company)
                                        <option value="{{ $company->id }}" {{ $ad->adblue_company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td><input type="number" step="0.01" name="adblue_details[{{ $i }}][quantity]" class="form-control form-control-sm adblue-quantity" value="{{ $ad->quantity }}"></td>
                                <td><input type="number" step="0.01" name="adblue_details[{{ $i }}][rate]" class="form-control form-control-sm adblue-rate" value="{{ $ad->rate }}"></td>
                                <td><input type="number" step="0.01" name="adblue_details[{{ $i }}][amount]" class="form-control form-control-sm adblue-amount" value="{{ $ad->amount }}"></td>
                                <td><input type="number" step="0.01" name="adblue_details[{{ $i }}][km]" class="form-control form-control-sm adblue-km" value="{{ $ad->km }}"></td>
                                <td>
                                    <select name="adblue_details[{{ $i }}][payment_type]" class="form-select form-select-sm">
                                        <option value="">Select</option>
                                        <option value="credit" {{ strtolower($ad->payment_type) == 'credit' ? 'selected' : '' }}>Credit</option>
                                        <option value="debit" {{ strtolower($ad->payment_type) == 'debit' ? 'selected' : '' }}>Debit</option>
                                        <option value="cash" {{ strtolower($ad->payment_type) == 'cash' ? 'selected' : '' }}>Cash</option>
                                    </select>
                                </td>
                            ...
                            @empty
                            <tr class="adblue-row">
                                <td><input type="date" max="9999-12-31" name="adblue_details[0][date]" class="form-control form-control-sm"></td>
                                <td>
                                ...
                                <td><input type="number" step="0.01" name="adblue_details[0][quantity]" class="form-control form-control-sm adblue-quantity" value="0"></td>
                                <td><input type="number" step="0.01" name="adblue_details[0][rate]" class="form-control form-control-sm adblue-rate" value="0"></td>
                                <td><input type="number" step="0.01" name="adblue_details[0][amount]" class="form-control form-control-sm adblue-amount" value="0"></td>
                                <td><input type="number" step="0.01" name="adblue_details[0][km]" class="form-control form-control-sm adblue-km" value="0"></td>
                                <td>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm table-sm-compact" id="otherTable">
                        <thead class="table-light">
                            <tr>
                                <th>Title</th>
                                <th>Amount (₹)</th>
                        ...
                        <tbody id="otherContainer">
                            @forelse($trip->otherAmountDetails as $i => $oa)
                            <tr class="other-row">
                                <td><input type="text" name="other_details[{{ $i }}][title]" class="form-control form-control-sm" placeholder="Title" value="{{ $oa->title }}"></td>
                                <td><input type="number" step="0.01" name="other_details[{{ $i }}][amount]" class="form-control form-control-sm other-amount" value="{{ $oa->amount }}"></td>
                                <td><input type="date" max="9999-12-31" name="other_details[{{ $i }}][date]" class="form-control form-control-sm" value="{{ $oa->date ? $oa->date->format('Y-m-d') : '' }}"></td>
                                <td><input type="text" name="other_details[{{ $i }}][remark]" class="form-control form-control-sm" placeholder="Remark" value="{{ $oa->remark }}"></td>
                                <td><button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="bx bx-trash"></i></button></td>
                            </tr>
                            @empty
                            <tr class="other-row">
                                <td><input type="text" name="other_details[0][title]" class="form-control form-control-sm" placeholder="Title"></td>
                                <td><input type="number" step="0.01" name="other_details[0][amount]" class="form-control form-control-sm other-amount" value="0"></td>
                                <td><input type="date" max="9999-12-31" name="other_details[0][date]" class="form-control form-control-sm"></td>
                                <td><input type="text" name="other_details[0][remark]" class="form-control form-control-sm" placeholder="Remark"></td>
                                <td><button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="bx bx-trash"></i></button></td>
                            </tr>
                            @endforelse
                        </tbody>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div id="advanceContainer">
                    @forelse($trip->advanceDetails as $i => $ad)
                    <div class="advance-entry border rounded p-3 mb-3">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label small">Date</label>
                                <input type="date" max="9999-12-31" name="advance_details[{{ $i }}][date]" class="form-control form-control-sm" value="{{ $ad->date ? $ad->date->format('Y-m-d') : '' }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Fuel Company</label>
                                <select name="advance_details[{{ $i }}][fuel_company_id]" class="form-select form-select-sm advance-company-select">
                                    <option value="">Select Company</option>
                                    @foreach($fuelCompanies as $company)
                                    <option value="{{ $company->id }}" {{ $ad->fuel_company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Fuel Pump</label>
                                <select name="advance_details[{{ $i }}][fuel_pump_id]" class="form-select form-select-sm advance-pump-select">
                                    <option value="">Select Pump</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small">Advance Amount (₹)</label>
                                <input type="number" step="0.01" name="advance_details[{{ $i }}][advance_amount]" class="form-control form-control-sm advance-amount" value="{{ $ad->advance_amount }}">
                            </div>
                        </div>
                        <div class="row g-3 mt-1">
                            <div class="col-md-9">
...
<script>
    $(document).ready(function() {
        ...
        @if($trip->fuelDetails->count())
        @foreach($trip->fuelDetails as $i => $fd)
        @if($fd->fuel_company_id)
        loadPumps($('.fuel-company-select').eq({{ $i }}), {{ $fd->fuel_pump_id }});
        @endif
        @endforeach
        @endif

        @if($trip->advanceDetails->count())
        @foreach($trip->advanceDetails as $i => $ad)
        @if($ad->fuel_company_id)
        loadPumps($('.advance-company-select').eq({{ $i }}), {{ $ad->fuel_pump_id }});
        @endif
        @endforeach
        @endif
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success && res.data.length) {
                        ...
                        $.each(res.data, function(i, row) {
                            const idx = baseIdx + i;
                            const html = `<tr class="adblue-row">
                                <td><input type="date" max="9999-12-31" name="adblue_details[${idx}][date]" class="form-control form-control-sm" value="${row.date || ''}"></td>
                                <td>
                                ...
                                <td><input type="number" step="0.01" name="adblue_details[${idx}][quantity]" class="form-control form-control-sm adblue-quantity" value="${row.quantity || 0}"></td>
                                <td><input type="number" step="0.01" name="adblue_details[${idx}][rate]" class="form-control form-control-sm adblue-rate" value="${row.rate || 0}"></td>
                                <td><input type="number" step="0.01" name="adblue_details[${idx}][amount]" class="form-control form-control-sm adblue-amount" value="${row.amount || 0}"></td>
                                <td><input type="number" step="0.01" name="adblue_details[${idx}][km]" class="form-control form-control-sm adblue-km" value="${row.km || 0}"></td>
                                <td>
        ...
        $('#addAdBlueRow').click(function() {
            ...
            const html = `<tr class="adblue-row">
                <td><input type="date" max="9999-12-31" name="adblue_details[${idx}][date]" class="form-control form-control-sm"></td>
                <td>
                    <select name="adblue_details[${idx}][adblue_company_id]" class="form-select form-select-sm adblue-company-select">
                        <option value="">Select Company</option>
                        @foreach($adblueCompanies as $company)
                ...
                <td><input type="number" step="0.01" name="adblue_details[${idx}][quantity]" class="form-control form-control-sm adblue-quantity" value="0"></td>
                <td><input type="number" step="0.01" name="adblue_details[${idx}][rate]" class="form-control form-control-sm adblue-rate" value="0"></td>
                <td><input type="number" step="0.01" name="adblue_details[${idx}][amount]" class="form-control form-control-sm adblue-amount" value="0"></td>
                <td><input type="number" step="0.01" name="adblue_details[${idx}][km]" class="form-control form-control-sm adblue-km" value="0"></td>
                <td>
                    <select name="adblue_details[${idx}][payment_type]" class="form-select form-select-sm">
                        <option value="">Select</option>
                        <option value="credit">Credit</option>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success && res.data.length) {
                        ...
                        $.each(res.data, function(i, row) {
                            const idx = baseIdx + i;
                            const html = `<tr class="other-row">
                                <td><input type="text" name="other_details[${idx}][title]" class="form-control form-control-sm" placeholder="Title" value="${row.title || ''}"></td>
                                <td><input type="number" step="0.01" name="other_details[${idx}][amount]" class="form-control form-control-sm other-amount" value="${row.amount || 0}"></td>
                                <td><input type="date" max="9999-12-31" name="other_details[${idx}][date]" class="form-control form-control-sm" value="${row.date || ''}"></td>
                                <td><input type="text" name="other_details[${idx}][remark]" class="form-control form-control-sm" placeholder="Remark" value="${row.remark || ''}"></td>
                                <td><button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="bx bx-trash"></i></button></td>
                            </tr>`;
        ...
        $('#submitAdvanceImport').click(function() {
            ...
            const formData = new FormData();
            formData.append('file', file);
            formData.append('fuel_company_id', $('#modalAdvanceCompany').val() || '');
            formData.append('fuel_pump_id', $('#modalAdvancePump').val() || '');
            formData.append('_token', '{{ csrf_token() }}');
        ...
        $('#addOtherRow').click(function() {
            ...
            const html = `<tr class="other-row">
                <td><input type="text" name="other_details[${idx}][title]" class="form-control form-control-sm" placeholder="Title"></td>
                <td><input type="number" step="0.01" name="other_details[${idx}][amount]" class="form-control form-control-sm other-amount" value="0"></td>
                <td><input type="date" max="9999-12-31" name="other_details[${idx}][date]" class="form-control form-control-sm"></td>
                <td><input type="text" name="other_details[${idx}][remark]" class="form-control form-control-sm" placeholder="Remark"></td>
                <td><button type="button" class="btn btn-sm btn-outline-danger remove-row"><i class="bx bx-trash"></i></button></td>
            </tr>`;
            $('#otherContainer').append(html);
        });
