                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select">
                            <option value="pending" {{ old('status', 'pending') == 'pending' ? 'selected' : '' }}>Pending (Trip in progress)</option>
                            <option value="complete" {{ old('status') == 'complete' ? 'selected' : '' }}>Complete (Trip finished)</option>
