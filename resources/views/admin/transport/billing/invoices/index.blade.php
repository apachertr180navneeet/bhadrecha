...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-3">
        <div>
            <h5 class="fw-bold mb-1">Invoice History</h5>
                ...
                <table class="table table-striped table-hover mb-0">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>Type</th>
                            <th>
                                <a href="{{ request()->fullUrlWithQuery(['date_sort' => request('date_sort') === 'oldest' ? 'latest' : 'oldest']) }}" class="text-white d-flex align-items-center gap-1 text-decoration-none">
                                    Date <i class="bx {{ request('date_sort') === 'oldest' ? 'bx-sort-up text-warning' : 'bx-sort-down text-warning' }}"></i>
                                </a>
                            </th>
                        ...
                        <tr>
                            ...
                            <td>
                                @if(($inv->invoice_type ?? 'freight') === 'toll')
                                    <span class="badge bg-label-info">Toll Bill</span>
                                @else
                                    <span class="badge bg-label-primary">Freight Bill</span>
                                @endif
                            </td>
                    ...
                    <tfoot class="table-dark fw-bold">
                        <tr>
                            ...
                            <td class="text-end">{{ number_format($invoices->sum('total_other'), 2) }}</td>
