...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-3">
        <div>
            <h5 class="fw-bold mb-1">AdBlue Companies</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item">Masters</li>
                    <li class="breadcrumb-item active">AdBlue Companies</li>
                </ol>
            </nav>
        </div>
        <div>
            ...
            <a href="{{ route('admin.masters.adblue-companies.download-template') }}" class="btn btn-outline-secondary"><i class="bx bx-download me-1"></i> Template</a>
            <a href="{{ route('admin.masters.adblue-companies.trashed') }}" class="btn btn-outline-danger"><i class="bx bx-trash me-1"></i> Recycle Bin</a>
            <a href="{{ route('admin.masters.adblue-companies.create') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i> Add AdBlue Company</a>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-2">
                    <a href="{{ route('admin.masters.adblue-companies.index') }}" class="btn btn-outline-secondary w-100">Clear</a>
                </div>
                @endif
            </form>
        </div>
    ...
    <div class="card">
        ...
        @if($adblueCompanies->hasPages())
        <div class="card-footer bg-transparent border-top py-3">{{ $adblueCompanies->links() }}</div>
        @endif
    </div>
</div>
...
<div class="modal fade" id="importModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.masters.adblue-companies.import') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header"><h5 class="modal-title">Import AdBlue Companies</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    function handleDelete(id, name) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = "{{ url('admin/masters/adblue-companies') }}/" + id;
                form.submit();
            }
        })
    }
