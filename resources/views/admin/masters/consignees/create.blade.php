...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <div>
            <h5 class="mb-0">Add Consignee</h5>
    ...
    <div class="card"><div class="card-body">
        <form method="POST" action="{{ route('admin.masters.consignees.store') }}">
            @csrf
            ...
            <div class="mt-4 d-grid gap-2 d-md-flex"><button type="submit" class="btn btn-primary">Save Consignee</button> <a href="{{ route('admin.masters.consignees.index') }}" class="btn btn-secondary">Cancel</a></div>
        </form>
    </div></div>
</div>
@endsection
