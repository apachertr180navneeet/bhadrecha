                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="tyre_position" class="form-select select2 @error('tyre_position') is-invalid @enderror" required>
                            ...
                            <optgroup label="Left Side (8 Slots)">
                                ...
                                <option value="L8" {{ old('tyre_position') == 'L8' ? 'selected' : '' }}>L8 - Axle 5 Rear Left 1</option>
                                <option value="L9" {{ old('tyre_position') == 'L9' ? 'selected' : '' }}>L9 - Axle 6 Rear Left 2</option>
                            </optgroup>
                            <optgroup label="Right Side (9 Slots)">
                                ...
                                <option value="R8" {{ old('tyre_position') == 'R8' ? 'selected' : '' }}>R8 - Axle 5 Rear Right 1</option>
                                <option value="R9" {{ old('tyre_position') == 'R9' ? 'selected' : '' }}>R9 - Axle 6 Rear Right 2</option>
                            </optgroup>
