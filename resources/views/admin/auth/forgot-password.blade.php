...
<style>
    ...
    .btn-primary:hover {
        ...
        box-shadow: 0 12px 25px rgba(105, 108, 255, 0.35);
...
<div class="auth-wrapper">
    <div class="auth-card">
        <div class="brand-header">
            <div class="brand-icon"><i class='bx bx-lock-open-alt'></i></div>
        ...
        <form action="{{ route('admin.forget.password.post') }}" method="POST">
            ...
            <button type="submit" class="btn btn-primary">Send Reset Link <i class='bx bx-send ms-1'></i></button>
        </form>
