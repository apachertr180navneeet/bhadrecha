...
class FuelCompanyImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure, WithEvents
{
    use Importable;
    ...
    public function model(array $row)
    {
        ...
        if (FuelCompany::where('name', $name)->exists()) {
            $this->skipped++;
            return null;
        }
