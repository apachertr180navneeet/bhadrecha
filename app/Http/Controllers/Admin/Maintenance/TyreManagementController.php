...
class TyreManagementController extends Controller
{
    ...
    public function updatePosition(Request $request)
    {
        ...
        $allSlots = [
            ...
            'L8' => ['name' => 'Rear Left 1 (L8)', 'aliases' => ['L8', 'RL8']],
            'R8' => ['name' => 'Rear Right 1 (R8)', 'aliases' => ['R8', 'RR8']],
            'L9' => ['name' => 'Rear Left 2 (L9)', 'aliases' => ['L9', 'RL9']],
            'R9' => ['name' => 'Rear Right 2 (R9)', 'aliases' => ['R9', 'RR9']],
