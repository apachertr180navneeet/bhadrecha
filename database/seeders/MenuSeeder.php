...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $reportsChildren = [
            ...
            ['title' => 'Fuel Outstanding', 'icon' => 'bx bx-wallet', 'route_name' => 'admin.reports.fuel-outstanding', 'order' => 9, 'permission' => 'view fuel outstanding'],
            ['title' => 'AdBlue Outstanding', 'icon' => 'bx bx-water', 'route_name' => 'admin.reports.adblue-outstanding', 'order' => 10, 'permission' => 'view adblue outstanding'],
